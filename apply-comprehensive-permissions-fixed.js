...
// Replace the section - keep everything before start, add replacement, keep everything from end marker onwards
const before = content.substring(0, startIndex);
const after = content.substring(endIndex); // This includes "// Create New User" and everything after
