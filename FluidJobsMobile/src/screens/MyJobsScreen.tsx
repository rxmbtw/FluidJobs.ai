  ...
  const fetchJobs = async () => {
    try {
      ...
      const mockData = [{
        ...
        registrationOpens: '11:00AM, 25 Oct 2025',
        registrationCloses: '11:00AM, 29 Oct 2025',
        description: 'FluidLive is a Technology Solutions company with modern techno-creative fluid blend as its principle. Developing economically feasible, artistically adaptable',
        skills: ['Python', 'C/C++', 'Java'],
      }];
      setJobs(mockData);
      setDisplayJobs(mockData);
    } catch (error) {
