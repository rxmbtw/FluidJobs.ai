...
const LoginPage: React.FC<LoginPageProps> = ({ onNavigateHome, onNavigateToDashboard, onNavigateToAdminDashboard, onNavigateToComingSoon, onNavigateToRegistrationSuccess }) => {
    return (
