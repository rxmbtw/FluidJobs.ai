...
const Dashboard: React.FC = () => {
  ...
  const filteredCandidates = useMemo(() => {
    ...
    switch (timeFilter) {
      ...
      case '30_days':
        ...
        break;
      default:
        return candidates; // Show all for custom or unknown filters
    }
  ...
  const stats = useMemo(() => {
    ...
    const active = filteredCandidates.filter(c => 
      ![InterviewStage.REJECTED, InterviewStage.JOINED].includes(c.currentStage)
    ).length;
    ...
    <div className="space-y-8 animate-in fade-in duration-500 pb-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
        <KPICard 
          ...
          trend={timeFilter === 'today' ? '5%' : timeFilter === '7_days' ? '12%' : '18%'} 
          trendUp 
          icon={Inbox} 
          color="blue" 
        />
        <KPICard 
          ...
          trend={timeFilter === 'today' ? '2%' : timeFilter === '7_days' ? '5%' : '8%'} 
          trendUp 
          icon={Clock} 
          color="yellow" 
        />
        <KPICard 
          ...
          trend={timeFilter === 'today' ? '1%' : timeFilter === '7_days' ? '3%' : '6%'} 
        ...
        <KPICard 
          ...
          trend={timeFilter === 'today' ? '3%' : timeFilter === '7_days' ? '8%' : '12%'} 
          trendUp 
          icon={UserX} 
          color="red" 
        />
        <KPICard 
          ...
          trend={timeFilter === 'today' ? '0%' : timeFilter === '7_days' ? '2%' : '4%'} 
          trendUp 
          icon={Star} 
          color="green" 
        />
        <KPICard 
          ...
          trend={timeFilter === 'today' ? '0%' : timeFilter === '7_days' ? '1%' : '2%'} 
          trendUp={false} 
          icon={UserMinus} 
          color="gray" 
        />
