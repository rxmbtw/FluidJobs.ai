...
const ManageCandidates: React.FC<ManageCandidatesProps> = ({ isJobSpecific = false, isSuperAdmin = false }) => {
  ...
  // Sync URL params with selected candidate
  React.useEffect(() => {
              ...
              <>
                {filteredOptions.map((option, index) => (
                  <div
                    ...
                    className={`px-3 py-2 text-xs cursor-pointer hover:bg-blue-50 transition flex items-center justify-between ${selectedItems.includes(option) ? 'bg-blue-50 text-blue-600' : 'text-gray-700'
                      }`}
                  >
                    <span>{option}</span>
            ...
            {filteredOptions.length > 0 ? (
              filteredOptions.map((option, index) => (
                <div
                  ...
                  className={`px-3 py-2 text-xs cursor-pointer hover:bg-blue-100 transition ${value === option ? 'bg-blue-100 text-blue-600' : 'text-gray-700'
                    }`}
                >
                  {option}
                </div>
  ...
  return (
    <div className="flex bg-gray-50 font-sans border-2 border-gray-200 rounded-lg" style={{ height: 'calc(100% - 16px)', margin: '8px' }}>
      ...
      <div className="w-[30%] bg-white border-r border-gray-200 flex flex-col">
        ...
        <div className="flex-1 flex relative">
          {/* Candidates List */}
          <div className="flex-1 overflow-y-auto px-4 pb-8" style={{ overflowX: 'hidden' }}>
      ...
      <div className="flex-1 flex flex-col">
        {selectedCandidate && (
          <>
              ...
              <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex space-x-3">
                  <button
                    ...
                    className={`flex items-center space-x-2 px-6 py-2.5 rounded-full text-sm font-medium transition border ${isRestricted ? 'bg-gray-100 text-gray-400 border-gray-300 cursor-not-allowed' : 'bg-white text-gray-700 border-gray-300 hover:bg-gray-50'
                      }`}
                  >
                  ...
                  <button
                    ...
                    disabled={!isRestricted}
                    className={`flex items-center space-x-2 px-6 py-2.5 rounded-full text-sm font-medium transition border ${!isRestricted ? 'bg-gray-100 text-gray-400 border-gray-300 cursor-not-allowed' : 'bg-white text-green-700 border-green-300 hover:bg-green-50'
                      }`}
                  >
                ...
                <div className="flex space-x-3">
                  <button
                    className={`flex items-center space-x-2 px-6 py-2.5 rounded-full text-sm font-medium ${isRestricted ? 'bg-red-100 text-red-700' : 'bg-green-100 text-green-700'
                      }`}
                  >
                    {isRestricted ? (
                  ...
                  <button
                    ...
                    className={`px-6 py-2.5 rounded-full text-sm font-medium transition ${isRestricted
            ...
            {/* Main Content */}
            <div className="flex-1 overflow-y-auto bg-gray-50 p-6" style={{ overflowX: 'hidden' }}>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {candidateJobStatuses.map((status) => (
                          <button
                            ...
                            className={`px-4 py-2 rounded-full text-sm font-semibold shadow-md hover:shadow-lg transition-all cursor-pointer ${status.status === 'shortlisted'
