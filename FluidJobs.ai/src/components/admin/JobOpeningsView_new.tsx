  ...
  const fetchJobs = async () => {
    try {
      ...
      if (result.success && result.jobs) {
        const formattedJobs: JobData[] = result.jobs.map((job: any) => ({
          ...
          workplace: job.workplace || job.job_type,
          tags: [job.job_domain],
            ...
            {displayedJobs.map((job) => (
              ...
              >
                ...
                <div className="p-3">
                  ...
                  <div className="mb-2 pb-2 border-b border-gray-100 flex flex-wrap items-center gap-1.5">
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-3">
                    <div>
                      <div className="text-[10px] text-gray-400 uppercase">JOB TYPE</div>
                      <div className="text-xs font-medium text-gray-900">{job.workplace}</div>
                    </div>
                    <div>
                      <div className="text-[10px] text-gray-400 uppercase">Annual CTC</div>
                      <div className="text-xs font-medium text-gray-900">{formatSalary(job.min_salary, job.max_salary)}</div>
                    </div>
                    <div>
                      <div className="text-[10px] text-gray-400 uppercase">INDUSTRY</div>
                      <div className="text-xs font-medium text-gray-900">{job.job_domain || 'Technology'}</div>
                    </div>
                    <div>
                      <div className="text-[10px] text-gray-400 uppercase">LOCATION</div>
                      <div className="text-xs font-medium text-gray-900">{job.location}</div>
                    </div>
                  </div>
